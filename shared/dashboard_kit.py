...
const GB_I18N = {
  en: {
    ...
    aboutCoverDesk: "Desk joins headline series across products for a single snapshot; each product page remains the place for filters and full history.",
  ...
  pt: {
    ...
    aboutCoverDesk: "O Desk junta séries-resumo entre produtos; cada painel permanece o lugar para filtros e o histórico completo.",
