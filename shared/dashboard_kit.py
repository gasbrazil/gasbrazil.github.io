...
const GB_I18N = {
  en: {
    ...
    aboutCoverFlows: "Pipeline Flows has no ANP data for 2022 and typically lags several weeks. TSB/GOM can be toggled.",
  ...
  pt: {
    ...
    aboutCoverFlows: "Fluxos: sem dados ANP para 2022 e com atraso típico de semanas. TSB/GOM podem ser ligados.",
