...
const GB_I18N = {
  en: {
    ...
    magoLegendSev: "Severo (Critical)",
    magoLegendAlt: "Alto (Alert)",
    magoLegendMarg: "Marginal (Target)",
    ...
    magoHmAlertHours: "Alert Hours (Alto)",
    magoHmCriticalHours: "Critical Hours (Severo)",
    ...
    magoHistAlerts: "Alerts & Breaches Only (Alto & Severo)",
