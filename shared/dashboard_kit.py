...
const GB_I18N = {
  en: {
    ...
    tagline: "Open Data for Brazil's Gas and Power Markets",
    ...
    cardMonitorDesc: "Operational line pack & SCADA telemetry.",
    ...
    methodAssump_desk: "Cross-market overview across natural gas prices, power dispatch, pipeline flows, and grid inventory.",
    ...
    ntsLinepackSub: "Pipeline line pack inventory and hourly packing rate.",
    ...
    magoFaixasSub: "Balancing tolerance thresholds for TAG's integrated pipeline system.",
    magoHeatmapTitle: "Operating Risk & Imbalance Breach Heatmap",
    magoHeatmapSub: "Historical daily line pack inventory across commercial tolerance tiers.",
    magoHmAll: "All Days",
    ...
    magoLinepackHistSub: "Hourly integrated line pack history.",
    ...
    aboutCoverDesk: "Cross-market summaries; granular data and interactive filters reside on individual dashboards.",
  ...
  pt: {
    ...
    tagline: "Dados Abertos para os Mercados de Gás e Energia do Brasil",
    ...
    cardMonitorDesc: "Empacotamento operacional e telemetria SCADA.",
    monitorTabTag: "TAG Mago",
    monitorTabNts: "NTS OnTime",
    deskLinkOns: "ONS",
    ...
    methodAssump_desk: "Visão consolidada entre preços de gás, despacho termelétrico, fluxos e empacotamento.",
    ...
    ntsLinepackSub: "Estoque de gás na malha e taxa horária de empacotamento.",
    ...
    magoFaixasSub: "Limiares de tolerância de balanceamento para a malha integrada da TAG.",
    magoHeatmapTitle: "Mapa de Risco Operacional e Violações de Desbalanço",
    magoHeatmapSub: "Histórico diário do empacotamento por faixa de tolerância.",
    ...
    magoLinepackHistSub: "Histórico horário de empacotamento integrado.",
    ...
    aboutCoverDesk: "Resumos consolidados; dados granulares e filtros residem em cada painel individual.",
...
def methodology_html(self_id: str) -> str:
    ...
    return (
        ...
        f'<span>{sources} &middot; <a href="../wiki/" data-i18n="navWiki">Wiki</a></span></div>\n'
...
def standard_footer_html(home_href: str = "../") -> str:
    """Standardized minimal footer across all pages and dashboards."""
    return (
        f'&copy; <span id="year"></span> GasBrazil.com '
        f'&middot; <a href="{home_href}wiki/" data-i18n="navWiki">Wiki</a> '
        f'&middot; <a href="{home_href}about/" data-i18n="footerAbout">About &amp; methodology</a> '
        f'&middot; <button type="button" class="footer-link-btn" id="link-shortcuts" data-i18n="shortcutsBtn">Shortcuts (?)</button> '
        f'&middot; <span data-i18n="contact">Contact</span>: <a href="mailto:eb@gasbrazil.com">eb@gasbrazil.com</a>'
    )
...
_METHOD_ASSUMP_DEFAULTS = {
    ...
    "desk": "Cross-market overview across natural gas prices, power dispatch, pipeline flows, and grid inventory.",
}
