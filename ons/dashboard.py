...
const ONS_I18N = {
  en: {
    ...
    tipReservoirs: "Every reservoir ONS tracks, charted as usable volume % or upstream level, with region and basin rollups above the per-reservoir picker. EAR is stored energy rather than raw volume, which is what makes cascades comparable. Reservoirs down usually means more thermal (and gas) later."
  },
  pt: {
    ...
    tipReservoirs: "Cada reservatório acompanhado pela ONS, em volume útil % ou nível de montante, com totais por região e bacia. EAR é energia armazenada, não volume bruto — por isso as cascadas são comparáveis. Reservatórios baixos costumam antecipar mais térmica (e gás)."
  }
};
function ot(key) {
